...
static void test_create_note(TestFixture *fixture, gconstpointer user_data) {
    ModelElement *element = model_create_note(fixture->model, 100, 200, 50, 30, "Test Note");
...
static void test_create_paper_note(TestFixture *fixture, gconstpointer user_data) {
    ModelElement *element = model_create_paper_note(fixture->model, 300, 400, 80, 40, "Test Paper Note");
...
static void test_create_connection(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *element1 = model_create_note(fixture->model, 100, 100, 50, 30, "Element 1");
    ModelElement *element2 = model_create_note(fixture->model, 200, 200, 50, 30, "Element 2");

    g_assert_nonnull(element1);
    g_assert_nonnull(element2);

    // Create connection between them
    ModelElement *connection = model_create_connection(fixture->model, element1->uuid, element2->uuid, 0, 2);
...
static void test_create_space_element(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *element = model_create_space(fixture->model, 500, 600, 100, 100, target_space_uuid);
...
static void test_model_load_space(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *note = model_create_note(fixture->model, 100, 200, 50, 30, "Test Note");
    ModelElement *paper_note = model_create_paper_note(fixture->model, 300, 400, 80, 40, "Test Paper Note");

    // Create a target space first
    char *target_space_uuid = NULL;
    database_create_space(fixture->db, "Target Space", NULL, &target_space_uuid);
    ModelElement *space_element = model_create_space(fixture->model, 500, 600, 100, 100, target_space_uuid);

    // Create connection between note and paper_note
    ModelElement *connection = model_create_connection(fixture->model, note->uuid, paper_note->uuid, 0, 2);
...
static void test_model_update_text(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *element = model_create_note(fixture->model, 100, 200, 50, 30, "Initial Text");
    g_assert_nonnull(element);
...
static void test_model_delete_element(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *saved_element = model_create_note(fixture->model, 300, 400, 60, 40, "Saved Note");
...
static void test_model_element_fork(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *original_note = model_create_note(fixture->model, 100, 200, 50, 30, "Original Note");
    ModelElement *original_paper_note = model_create_paper_note(fixture->model, 300, 400, 80, 40, "Original Paper Note");

    // Create a target space for space element
    char *target_space_uuid = NULL;
    database_create_space(fixture->db, "Target Space", NULL, &target_space_uuid);
    ModelElement *original_space = model_create_space(fixture->model, 500, 600, 100, 100, target_space_uuid);

    // Create connection between note and paper_note
    ModelElement *original_connection = model_create_connection(fixture->model,
        original_note->uuid, original_paper_note->uuid, 0, 2);
...
static void test_model_element_fork_independence(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *original_note = model_create_note(fixture->model, 100, 200, 50, 30, "Original Text");
    g_assert_nonnull(original_note);
...
static void test_model_element_clone_by_text(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *new_note = model_create_note(fixture->model, 300, 400, 60, 40, "New Note");
    ...
    ModelElement *deleted_note = model_create_note(fixture->model, 500, 600, 70, 50, "Deleted Note");
...
static void test_model_save_new_elements(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *note1 = model_create_note(fixture->model, 100, 200, 50, 30, "Note 1");
    ModelElement *note2 = model_create_note(fixture->model, 300, 400, 60, 40, "Note 2");
    ModelElement *paper_note = model_create_paper_note(fixture->model, 500, 600, 80, 50, "Paper Note");
...
static void test_model_save_cloned_text_reference(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *original = model_create_note(fixture->model, 100, 200, 50, 30, "Shared Text");
...
static void test_model_save_updated_elements(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *element2 = model_create_note(fixture->model, 500, 600, 70, 50, "Element 2");
    g_assert_nonnull(element2);
...
static void test_model_delete_element_comprehensive(TestFixture *fixture, gconstpointer user_data) {
    ...
    ModelElement *element1 = model_create_note(fixture->model, 100, 200, 50, 30, "Shared Text");
    ModelElement *element3 = model_create_note(fixture->model, 500, 600, 50, 30, "Different Text");
